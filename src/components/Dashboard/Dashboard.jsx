  ...
  return (
    <div className="flex h-screen bg-gray-100">
      <aside className="w-64 bg-white shadow-md">
        ...
        <nav className="mt-6">
          <Link to="/dashboard" className=" py-2 px-4 text-gray-700 hover:bg-gray-200 flex items-center">
            <FaHome className="mr-2" /> Dashboard
          </Link>
          <Link to="/upload-property" className=" py-2 px-4 text-gray-700 hover:bg-gray-200 flex items-center">
            <FaUpload className="mr-2" /> Upload Property
          </Link>
          <Link to="/leads" className=" py-2 px-4 text-gray-700 hover:bg-gray-200 flex items-center">
